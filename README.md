...
**Hello rails back end** is a simple web app that combines functionalities of Ruby on Rails and React. It allows users to get a random greeting from the backend API.
...
```sh
  cd my-folder
  git clone git@github.com:hammaazarok/hello-rails-back-end.git
```
